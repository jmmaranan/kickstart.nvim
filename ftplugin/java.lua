...
local on_attach = require("lsp.share").on_attach
local nmap = require("lsp.share").nmap
...
local config = {
  ...
  cmd = {
    ...
    '-jar', vim.fn.glob(home .. '/workspace/git/eclipse.jdt.ls/org.eclipse.jdt.ls.product/target/repository/plugins/org.eclipse.equinox.launcher_*.jar'),

    -- The configuration for jdtls is also placed where jdtls was installed. This will
    -- need to be updated depending on your environment
    '-configuration', home .. '/workspace/git/eclipse.jdt.ls/org.eclipse.jdt.ls.product/target/repository/config_mac_arm',
